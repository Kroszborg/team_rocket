...
function DashboardPage() {
  ...
  const { campaigns, loading: campaignsLoading, error, fetchCampaigns, deleteCampaign } = useCampaigns()
          ...
          <div className="p-6">
            {campaignsLoading ? (
              ...
              <div className="text-center py-12">
                <div className="text-red-500 mb-2">Failed to load campaigns</div>
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">Create your first campaign to get started with optimization</p>
                <Link 
                  href="/campaign-lab"
                  className="inline-block bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-medium transition duration-200"
                >
              ...
              <div className="space-y-4">
                {campaigns.map((campaign) => (
                  <div key={campaign.id} className="border border-gray-200 rounded-lg p-6 hover:border-gray-300 transition duration-200">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                          ...
                          <div>
                            ...
                            <p className="font-medium text-green-600">
                              {campaign.optimization_results?.expected_roi ? `${(campaign.optimization_results.expected_roi * 100).toFixed(1)}%` : 'N/A'}
                            </p>
                          </div>
                          <div>
